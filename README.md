...
| MODEMパラメータ | <details><summary>SIMの情報を取得する</summary><sub>IMEI,IMSIを取得する</sub></details> | [LTE-Param](HLTE-Param) | IMEI,IMSIを取得する|[公式サイト](https://github.com/SeeedJP/Wiki/blob/master/Wio_cell_lib_for_Arduino/reference-ja.md#getimei)|
