...
| 赤外線リモコン(扇風機操作)| <details><summary>赤外線信号で扇風機を操作</summary><sub>赤外線信号を送信して、扇風機の電源ON/OFF等の制御を実施します。</sub></details> | [Hello-IrRemocon-fan](Hello-IrRemocon-fan) | 扇風機の電源ON->電源OFF操作する赤外線信号を送信 (TODO:和久津) |[公式サイト](https://www.au.com/auhome/device/ura01a/)|
